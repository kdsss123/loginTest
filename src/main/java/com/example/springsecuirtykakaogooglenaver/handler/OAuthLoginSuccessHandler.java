...
import com.example.springsecuirtykakaogooglenaver.config.GoogleUserInfo;
import com.example.springsecuirtykakaogooglenaver.config.KakaoUserInfo;
import com.example.springsecuirtykakaogooglenaver.config.NaverUserInfo;
import com.example.springsecuirtykakaogooglenaver.config.OAuth2UserInfo;
import com.example.springsecuirtykakaogooglenaver.entity.RefreshToken;
import com.example.springsecuirtykakaogooglenaver.entity.User;
import com.example.springsecuirtykakaogooglenaver.repository.RefreshTokenRepository;
import com.example.springsecuirtykakaogooglenaver.repository.UserRepository;
...
public class OAuthLoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    @Value("${jwt.redirect}")
    private String REDIRECT_URI; // 프론트엔드로 Jwt 토큰을 리다이렉할 URI
